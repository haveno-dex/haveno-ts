...
export class BackupAccountReply extends jspb.Message {
  ...
  setData(value: Uint8Array | string): BackupAccountReply;
...
export class Zip extends jspb.Message {
  getContent(): Uint8Array | string;
  getContent_asU8(): Uint8Array;
  getContent_asB64(): string;
  setContent(value: Uint8Array | string): Zip;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): Zip.AsObject;
  static toObject(includeInstance: boolean, msg: Zip): Zip.AsObject;
  static serializeBinaryToWriter(message: Zip, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): Zip;
  static deserializeBinaryFromReader(message: Zip, reader: jspb.BinaryReader): Zip;
}
...
export class RestoreAccountRequest extends jspb.Message {
  ...
  setMetadata(value?: MetaData): RestoreAccountRequest;
  hasMetadata(): boolean;
  clearMetadata(): RestoreAccountRequest;

  getZip(): Zip | undefined;
  setZip(value?: Zip): RestoreAccountRequest;
  hasZip(): boolean;
  clearZip(): RestoreAccountRequest;

  getFoo(): string;
  setFoo(value: string): RestoreAccountRequest;

  getRequestCase(): RestoreAccountRequest.RequestCase;
...
export class RestoreAccountReply extends jspb.Message {
  getName(): string;
  setName(value: string): RestoreAccountReply;

  getStatus(): Status;
  setStatus(value: Status): RestoreAccountReply;
