...
goog.exportSymbol('proto.io.bisq.protobuffer.MetaData', null, global);
...
goog.exportSymbol('proto.io.bisq.protobuffer.RestoreAccountRequest.RequestCase', null, global);
...
goog.exportSymbol('proto.io.bisq.protobuffer.Status', null, global);
...
goog.exportSymbol('proto.io.bisq.protobuffer.Zip', null, global);
/**
 ...
 * @constructor
 */
proto.io.bisq.protobuffer.MetaData = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.io.bisq.protobuffer.MetaData, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.io.bisq.protobuffer.MetaData.displayName = 'proto.io.bisq.protobuffer.MetaData';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.io.bisq.protobuffer.Zip = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.io.bisq.protobuffer.Zip, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.io.bisq.protobuffer.Zip.displayName = 'proto.io.bisq.protobuffer.Zip';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.io.bisq.protobuffer.RestoreAccountRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.io.bisq.protobuffer.RestoreAccountRequest.oneofGroups_);
};
 ...
 */
proto.io.bisq.protobuffer.BackupAccountReply.prototype.getData = function() {
 ...
 * @return {string}
 */
proto.io.bisq.protobuffer.BackupAccountReply.prototype.getData_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.io.bisq.protobuffer.BackupAccountReply.prototype.getData_asU8 = function() {
 ...
 */
proto.io.bisq.protobuffer.BackupAccountReply.prototype.setData = function(value) {
 ...
 * @return {!Object}
 */
proto.io.bisq.protobuffer.MetaData.prototype.toObject = function(opt_includeInstance) {
  return proto.io.bisq.protobuffer.MetaData.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.io.bisq.protobuffer.MetaData} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.io.bisq.protobuffer.MetaData.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.io.bisq.protobuffer.MetaData}
 */
proto.io.bisq.protobuffer.MetaData.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.io.bisq.protobuffer.MetaData;
  return proto.io.bisq.protobuffer.MetaData.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.io.bisq.protobuffer.MetaData} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.io.bisq.protobuffer.MetaData}
 */
proto.io.bisq.protobuffer.MetaData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.io.bisq.protobuffer.MetaData.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.io.bisq.protobuffer.MetaData.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.io.bisq.protobuffer.MetaData} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.io.bisq.protobuffer.MetaData.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.io.bisq.protobuffer.MetaData.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.io.bisq.protobuffer.MetaData} returns this
 */
proto.io.bisq.protobuffer.MetaData.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.io.bisq.protobuffer.MetaData.prototype.getType = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.io.bisq.protobuffer.MetaData} returns this
 */
proto.io.bisq.protobuffer.MetaData.prototype.setType = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.io.bisq.protobuffer.Zip.prototype.toObject = function(opt_includeInstance) {
  return proto.io.bisq.protobuffer.Zip.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.io.bisq.protobuffer.Zip} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.io.bisq.protobuffer.Zip.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.io.bisq.protobuffer.Zip}
 */
proto.io.bisq.protobuffer.Zip.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.io.bisq.protobuffer.Zip;
  return proto.io.bisq.protobuffer.Zip.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.io.bisq.protobuffer.Zip} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.io.bisq.protobuffer.Zip}
 */
proto.io.bisq.protobuffer.Zip.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.io.bisq.protobuffer.Zip.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.io.bisq.protobuffer.Zip.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.io.bisq.protobuffer.Zip} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.io.bisq.protobuffer.Zip.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!(string|Uint8Array)}
 */
proto.io.bisq.protobuffer.Zip.prototype.getContent = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.io.bisq.protobuffer.Zip.prototype.getContent_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getContent()));
};
 ...
 * @return {!Uint8Array}
 */
proto.io.bisq.protobuffer.Zip.prototype.getContent_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getContent()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.io.bisq.protobuffer.Zip} returns this
 */
proto.io.bisq.protobuffer.Zip.prototype.setContent = function(value) {
  return jspb.Message.setProto3BytesField(this, 1, value);
};
 ...
 * @const
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.oneofGroups_ = [[1,2]];

/**
 * @enum {number}
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.RequestCase = {
  REQUEST_NOT_SET: 0,
  METADATA: 1,
  ZIP: 2
};
...
/**
 * @return {proto.io.bisq.protobuffer.RestoreAccountRequest.RequestCase}
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.getRequestCase = function() {
  return /** @type {proto.io.bisq.protobuffer.RestoreAccountRequest.RequestCase} */(jspb.Message.computeOneofCase(this, proto.io.bisq.protobuffer.RestoreAccountRequest.oneofGroups_[0]));
};
...
proto.io.bisq.protobuffer.RestoreAccountRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    metadata: (f = msg.getMetadata()) && proto.io.bisq.protobuffer.MetaData.toObject(includeInstance, f),
    zip: (f = msg.getZip()) && proto.io.bisq.protobuffer.Zip.toObject(includeInstance, f),
    foo: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
...
proto.io.bisq.protobuffer.RestoreAccountRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.io.bisq.protobuffer.MetaData;
      reader.readMessage(value,proto.io.bisq.protobuffer.MetaData.deserializeBinaryFromReader);
      msg.setMetadata(value);
      break;
    case 2:
      var value = new proto.io.bisq.protobuffer.Zip;
      reader.readMessage(value,proto.io.bisq.protobuffer.Zip.deserializeBinaryFromReader);
      msg.setZip(value);
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
...
proto.io.bisq.protobuffer.RestoreAccountRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.io.bisq.protobuffer.MetaData.serializeBinaryToWriter
    );
  }
  f = message.getZip();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.io.bisq.protobuffer.Zip.serializeBinaryToWriter
    );
  }
  f = message.getFoo();
  if (f.length > 0) {
 ...
 * @return {?proto.io.bisq.protobuffer.MetaData}
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.getMetadata = function() {
  return /** @type{?proto.io.bisq.protobuffer.MetaData} */ (
    jspb.Message.getWrapperField(this, proto.io.bisq.protobuffer.MetaData, 1));
};


/**
 * @param {?proto.io.bisq.protobuffer.MetaData|undefined} value
 * @return {!proto.io.bisq.protobuffer.RestoreAccountRequest} returns this
*/
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.setMetadata = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.io.bisq.protobuffer.RestoreAccountRequest.oneofGroups_[0], value);
};
 ...
 * @return {!proto.io.bisq.protobuffer.RestoreAccountRequest} returns this
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.clearMetadata = function() {
 ...
 * @return {boolean}
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.hasMetadata = function() {
 ...
 * @return {?proto.io.bisq.protobuffer.Zip}
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.getZip = function() {
  return /** @type{?proto.io.bisq.protobuffer.Zip} */ (
    jspb.Message.getWrapperField(this, proto.io.bisq.protobuffer.Zip, 2));
};


/**
 * @param {?proto.io.bisq.protobuffer.Zip|undefined} value
 * @return {!proto.io.bisq.protobuffer.RestoreAccountRequest} returns this
*/
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.setZip = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.io.bisq.protobuffer.RestoreAccountRequest.oneofGroups_[0], value);
};
 ...
 * @return {!proto.io.bisq.protobuffer.RestoreAccountRequest} returns this
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.clearZip = function() {
 ...
 * @return {boolean}
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.hasZip = function() {
 ...
 * @return {string}
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.getFoo = function() {
 ...
 * @return {!proto.io.bisq.protobuffer.RestoreAccountRequest} returns this
 */
proto.io.bisq.protobuffer.RestoreAccountRequest.prototype.setFoo = function(value) {
...
proto.io.bisq.protobuffer.RestoreAccountReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.io.bisq.protobuffer.Status} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {string}
 */
proto.io.bisq.protobuffer.RestoreAccountReply.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.io.bisq.protobuffer.RestoreAccountReply} returns this
 */
proto.io.bisq.protobuffer.RestoreAccountReply.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!proto.io.bisq.protobuffer.Status}
 */
proto.io.bisq.protobuffer.RestoreAccountReply.prototype.getStatus = function() {
  return /** @type {!proto.io.bisq.protobuffer.Status} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.io.bisq.protobuffer.Status} value
 * @return {!proto.io.bisq.protobuffer.RestoreAccountReply} returns this
 */
proto.io.bisq.protobuffer.RestoreAccountReply.prototype.setStatus = function(value) {
 ...
 * @enum {number}
 */
proto.io.bisq.protobuffer.Status = {
  PENDING: 0,
  IN_PROGRESS: 1,
  SUCCESS: 2,
  FAILED: 3
